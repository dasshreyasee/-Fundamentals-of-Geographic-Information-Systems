...
<div style="display: flex; gap: 40px; align-items: flex-start; margin-top: 20px;">
  ...
  <div>
    ...
    <img src="assets/Map_Lab1.png" alt="GIS Portfolio Map" width="340" style="border: 1px solid #ccc; border-radius: 4px;">
  </div>
  ...
  <div style="max-width: 380px;">
    ...
    <p>
      ...
      to environmental justice, urban infrastructure, and public health.
    </p>
